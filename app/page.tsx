...
import CustomerIntelligenceTables from '@/components/charts/CustomerIntelligenceTables'
...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<'bar' | 'line' | 'heatmap' | 'table' | 'waterfall' | 'bubble' | 'competitive-intelligence' | 'customer-intelligence' | 'customer-intelligence-tables'>('bar')
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Middle East Cooling Tower Market'}
              </h2>
            </div>
          </div>
              ...
              <div className="p-6">
                {viewMode === 'tabs' ? (
                  <>
                    ...
                    {activeTab === 'customer-intelligence-tables' && (
                      <div id="customer-intelligence-tables">
